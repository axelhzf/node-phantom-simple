...
exports.create = function (callback, options) {
    ...
    if (options.phantomPort === undefined) options.phantomPort = 3011;
    ...
    function spawnPhantom (callback) {
        ...
        args = args.concat([__dirname + '/bridge.js', options.phantomPort]);
        ...
        phantom.stdout.once('data', function (data) {
            ...
            if (!/Ready/.test(data)) {
                ...
                callback(null, phantom, options.phantomPort);
            }
        });
